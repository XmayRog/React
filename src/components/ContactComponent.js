...
class Contact extends Component {
    ...
    handleInputChange(event) {
        ...
        const value = target.type === 'checkbox' ? target.checked : target.avlue;
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.state.handleSubmit}>
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="firstname" name="firstname" placeholder="firstname" value={this.state.firstname}
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="text" id="lastname" name="lastname" placeholder="lastname" value={this.state.lastname}
                                    onChange={this.handleInputChange} />
                                </Col>
                            </FormGroup>
                            <FormGroup row>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={{size: 3, offset: 1}}>
                                    <Input type="select" anme="conatactType" value={this.state.contactType}
                                    onChange={this.handleInputChange}>
                                        <option>Tel.</option>
                                        <option>Email</option>
                                    </Input>
